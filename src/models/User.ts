...
export class UserModel {
  ...
  static async generateToken(userId: number, kind: 'regular' | 'refresh'): Promise<AuthToken> {
  ...
  static async findByToken(token: string): Promise<{ user: User; authToken: AuthToken } | null> {
  ...
  static async deleteUserTokens(userId: number, kind?: 'regular' | 'refresh'): Promise<void> {
    if (kind) {
